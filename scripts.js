...
function converterMoeda() {
  ...
  var cotacoes = {
    dolar: 1,
    real: 5.32, // Exemplo de cotação fictícia
    euro: 0.88, // Exemplo de cotação fictícia
    bitcoin: 0.000021, // Exemplo de cotação fictícia
    libra: 0.75 // Exemplo de cotação fictícia
  };
